...
const lore = [
  {
    class:"Berzerker",
    lore:"<b>Harkener</b> - the Beast Slayer - known for his heroism during the tribal army’s great battle against a Demon Horde of terrible beasts. The dark beasts struck fear into many of the tribe’s warriors with their onslaught. Yet Harkener, with a will of forged steel, rallied the warriors and turned the tide of glorious battle. Their leathery demon flesh succumbed to tribal steel crafted to cleave even the largest of beasts.<br/><br/> Harkener slew many a demon spawn that day. One after another they fell to his fierce blows and chilling battle cries until he conquered even their general. Demoralized and decimated, the demon horde retreated with unholy shrieks of terror. The fiery glow of their hellish doorway into our world faded until it was no more. Harkener earned the rank of Full Warrior that day. His flesh, scarred by Demon fire, is a reminder to all who ever questioned his loyalty to the tribe."
  },
  {
    class:"Sorcerer",
    lore:"<b>Seraph</b> - Subduer of Death - her story is legend amongst the river tribe. The villagers spoke of a fiery orange glow under the deep river that started as a flicker and grew slowly until it was strong enough to light the night sky. Then, the demon serpents bore outward from its depths and descended among the village killing many of its people. Seraph was on a moonlit hill that night, contemplating her recent betrothment. She witnessed this horror from afar. Many died before the warriors arose from their slumber. The demons slithered back into the night. Then, horror beset them all.<br/><br/> Many wailed and clutched the lifeless bodies of their loved ones. Seraph and the healers used their gifts but could only save so many. Seraph was able to resurrect and heal many...except her betrothed whom she loved. One by one, the healers began to collapse from the exhaustive use of their powers Yet there were still so many yet to be healed. Seraph, barely conscious, tears streaming from her eyes was visited by a vision of her betrothed. 'Seraph, my love, don’t weep for me. I must go now with the River Goddess', he said. Seraph, distraught, pleaded with the Goddess to return her betrothed.<br/><br/> Surprisingly, the River Goddess agreed but it came with a price. The Goddess told Seraph, 'One day a messenger will call upon my people for a champion. You must be that champion and leave your husband on this dangerous quest.' They both accepted the terms to be reunited. The Goddess continued,'I give you the Artifact of Great Healing. Go forth and prove yourself as the greatest healer of the village and resurrect my people.' Thus, the legend of Seraph was born."
  },
  {
    class:"Ranger",
    lore:"<b>Ragna</b> - Deliverer of Quiet Death. Little is known about this deadly, clever and hidden archer of the dark forest tribe save for one chilling tale. The demon horde descended upon the kingdom in the dark forest killing many of their tribe. After pushing them back, Ragna alone stalked the horde for days slowly reducing their numbers until a small paranoid band was left. Instead of killing them, he shot arrows at them strategically instilling further fear and herding them out of the forest. The demon horde never returned out of complete fear. "
  },
  {
    class:"Fairy",
    lore:"<b>Talia</b> - The Wind Rider - fast, clever and stronger than nearly all creatures in the realm. She volunteered out of boredom with eternal life accepting a bet against other fairies that she can’t be killed."
  }
];
